...
// Variables
const rootDomain = "kujeyvpn.my.id"; // Ganti dengan domain utama kalian
const serviceName = "artic"; // Ganti dengan nama workers kalian
const apiKey = "0bd7fe59248603092ad3e06b2c0ea7722c457"; // Ganti dengan Global API key kalian (https://dash.cloudflare.com/profile/api-tokens)
const apiEmail = "jey7vpn@gmail.com"; // Ganti dengan email yang kalian gunakan
const accountID = "1a62b13ff89ec5d503b5212f2942fa72"; // Ganti dengan Account ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
const zoneID = "c5f831b69a74ab41422dab39aea45c0e"; // Ganti dengan Zone ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
let isApiReady = true;
let proxyIP = "";
let cachedProxyList = [];
...
function getAllConfig(request, hostName, proxyList, page = 0) {
  ...
  try {
    ...
    document.setTitle("Welcome to <span class='text-blue-500 font-semibold'>ARTIC VPN</span>");
