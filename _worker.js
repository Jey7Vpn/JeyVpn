...
// Variables
const rootDomain = "jey7vpn.workers.dev"; // Ganti dengan domain utama kalian
...
const zoneID = "a1aa26dba0ec401e6d0b3308ffcf5781"; // Ganti dengan Zone ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
let isApiReady = true;
let proxyIP = "";
let cachedProxyList = [];
